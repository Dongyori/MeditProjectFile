  ...
  <b-navbar class="fixed-top" toggleable="md" type="dark" variant="info">
    ...
    <b-collapse is-nav id="nav_collapse">
      <b-navbar-nav class="header-links">
        ...
        <b-nav-item id="issueList" href="/issueList/" @click="changeActive(issueList)" :class="{active: activeTab === 'issueList' }"><i class="mdi mdi-email-outline"></i>Issue List</b-nav-item>
      </b-navbar-nav>

          ...
          <b-tabs class="autoTab">
            <b-tab title="Create Issue" active>
              <div data-v-19c9d02c="" class="card-body">
                <div class="row mb-5">
                <button data-v-35f42b37="" type="button" class="col-1 btn btn-fw btn-inverse-light btn-secondary">Light</button>
                <button data-v-35f42b37="" type="button" class="col-1 btn btn-fw btn-inverse-light btn-secondary">Light</button>
                <button data-v-35f42b37="" type="button" class="col-1 btn btn-fw btn-inverse-light btn-secondary">Light</button>
                <button data-v-35f42b37="" type="button" class="col-1 mr-5 btn btn-fw btn-inverse-light btn-secondary">Light</button>
              ...
              <table class="table center-aligned-table">
                <thead>
                  <tr>
                    ...
                    <th class="border-bottom-0">Issue Name</th>
